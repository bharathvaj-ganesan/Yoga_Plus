...
public class YouTubeFragment extends Fragment {
    ...
    private static final String YOUTUBE_PLAYLIST = "PL3uDtbb3OvDNSIvKFxhCVoplx_t4DOKIc";
    ...
    protected class PlaylistAdapter extends BaseAdapter {
        ...
        PlaylistAdapter(Playlist playlist , YouTubeFragment tempFr) {
            mPlaylist = playlist;
            // LayoutInflater inflater = ((Activity)MyContext)).getLayoutInflater;
            // mInflater = ((YoutubeActivity)mContext).getLayoutInflater();
            mInflater =  tempFr.getActivity().getLayoutInflater();
        }
